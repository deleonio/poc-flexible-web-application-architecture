...
npx lean serve --port 8080 & || { echo 'command failed' ; exit 1; }
npx $1 serve --port 8081 & || { echo 'command failed' ; exit 1; }
npx lean serve -- --port 8082 & || { echo 'command failed' ; exit 1; }
